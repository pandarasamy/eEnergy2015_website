...
function add_listitem($image, $name, $organization, $link)
{
	...
	if ($image) {
		printf('<div class="ui-grid-a"><div class="ui-block-a"><p style="float: left;padding-right:10px;border:none;"><img src="%s" width="80px" height="80px"</p><p>%s</p></div><div class="ui-block-b"><p>%s</p></div></div>',
